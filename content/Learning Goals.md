...
1. Detect cars and license plates in images using object detection models.
2. Extract text using OCR and preprocess it for consistency and accuracy.
3. Analyze and classify visual features like vehicle color.


### Current Experience
1. No experience with ML-image processing tools like OpenCV, YOLO, or EasyOCR.
2. No experience training or fine-tuning models.
3. No hands-on experience with deployment of ML in a computer vision pipeline.
